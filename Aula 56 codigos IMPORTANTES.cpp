...
void setup()
{
    ...
    Serial.toLowerCase(); // Alterar todas as letras para minusculas
    ...
    textoLed.replace("ON", "OFF"); // substitui uma palavra no texto por outro
    Serial.println(textoLed);      //"Led = OF"
